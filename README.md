# JPX/JBIG2 C# image decoder ([GitHub](https://github.com/gstolarov/JBIG2-JPX))
...
The application assumes that J2K files are JPX/JPEG2000, and JB2 files are JBIG. For each JB2 file it will check file with the same name and .GLOB extension. If this file is found it will be assumed to contain global symbols for GB2 file.
